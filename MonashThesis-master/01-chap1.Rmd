...
The main precedures of the human evaluating lineup are given in figure \ref{dghm}. "Real data" and "null data" stand for datasets simulated under the alternative hypothesis and the null hypothesis respectively. More detailed procedures related to each hypothesis test will be described in chapter 2 and chapter 3.
