...
```{r saurus, out.width = "400px", fig.cap="Each dataset has the same summary statistics to two decimal places: (E(x)=54.26, E(y)= 47.83, sd(x) = 16.76, sd(y) = 26.93, Pearson’s r = -0.06)."}
knitr::include_graphics("/Users/stanza/Documents/GitHub/ETF5550/MonashThesis-master/figures/datasaurus.png")
```

<!--

```{r datasaurus, fig.cap="Each dataset has the same summary statistics to two decimal places: ($\bar{x}$=54.26, $\bar{y}$= 47.83, sdx = 16.76, sdy = 26.93, Pearson’s r = -0.06)."}

datasaurus <- read.csv("/Users/stanza/Documents/GitHub/ETF5550/datasaurus.csv")
names(datasaurus) <- c("x","y")
ggplot(datasaurus, aes(x=x, y=y)) + geom_point()
