...
load("/Users/stanza/Documents/GitHub/ETF5550/MonashThesis-master/data/new_history.RData")
plot(history)
...
ctacc <- read.csv("/Users/stanza/Documents/GitHub/ETF5550/cortest_table.csv")
acc_ct_test <- mean(c(ctacc$accuracy_cortest_linear_test, ctacc$accuracy_cortest_norela_test))
acc_dl_test <- 
```
