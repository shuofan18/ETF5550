...
After first training attempt with 40,000 observations (20,000 of each class), the model's performance is shown below. The accuracy tested on unseen data is roughly 80.5%, where the test data is generated from the same specification with training data.

```{r history, echo=FALSE}
load("/Users/stanza/Documents/GitHub/ETF5550/MonashThesis-master/data/history2.RData")
plot(history)
