...
![Training and validation metrics of convnets for the first experiment](figures/heter_history_plot.png)
...
![The estimated power and overall accuracy of T-test and convnets for test set](figures/ttest_dl_graph.png)
