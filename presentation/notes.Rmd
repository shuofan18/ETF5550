...
## Goal
Hello everyone, I am Shuofan, my research project is about human and computer. Our goal in this paper is to teach the computer to read residual plots. 
...
However, computer has its own disadvantages, and is restricted by the presetting of training. As we can see in this case, the self-driving cars fails to detect the movement of kangaroos because their unique movement. Because the model was trained to detect movement based on the objects moving directions as left or right, forward and backwards but not up and down.
