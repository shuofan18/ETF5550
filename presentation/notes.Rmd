...
This is an example of lineup. Which plot do you think is the most different? (3) We reject the null hypothesis that the data follows linear relationship.
...
(the first line seems pretty simply and straightforward, isn't it? In fact, this is where I spent most of my time in the last month.)
...
3. Save residual plots as fixed-sized images (we set all plots as same fix-sized images, it makes the comparison more reasonable and also easier for deep learning model to process)
...
A lot of decisions have been made in the model design process.
