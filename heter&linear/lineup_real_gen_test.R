...
############################ 0527 test deep learning on real plots

heter11model <- load_model_hdf5("~/documents/github/etf5550/heter&linear/checkpoints/weights.11-0.08.hdf5")
heter4model <- load_model_hdf5("~/documents/github/etf5550/heter&linear/checkpoints/weights.11-0.08.hdf5")
test_dir <- "~/documents/github/etf5550/heter&linear/lineup_only_real_plots"
...
dlacc_test_hat <- heter4model %>% evaluate_generator(test_generator, steps = 27)
dlacc_test_hat
