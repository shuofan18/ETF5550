...
setwd("/Users/shuofanzhang/documents/heter&linear/test/linear")
...
setwd("/Users/shuofanzhang/documents/heter&linear/validation/linear")
accuracy_wtest_linear_validation <- sapply(1:40000, linear_train) %>% mean()
accuracy_wtest_linear_validation

######## image generating finish, start training ########### need to start from here ############### 20th May 2018 afternoon 
...
plot(history_heter)     #######20 th May #### up to here
